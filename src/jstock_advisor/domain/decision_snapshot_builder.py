...
def build_decision_snapshot(
    ...
    return DecisionSnapshot(
        ...
        market_confidence=recommendation.market_confidence,
        market_coverage=recommendation.market_coverage,
        market_reason_codes=recommendation.market_reason_codes,
        market_metrics=dict(recommendation.market_metrics),
        sector_score=recommendation.sector_score,
        sector_confidence=recommendation.sector_confidence,
        sector_coverage=recommendation.sector_coverage,
        sector_reason_codes=recommendation.sector_reason_codes,
        sector_metrics=dict(recommendation.sector_metrics),
        environment_score=recommendation.environment_score,
        environment_confidence=recommendation.environment_confidence,
        environment_coverage=recommendation.environment_coverage,
        environment_reason_codes=recommendation.environment_reason_codes,
        environment_metrics=dict(recommendation.environment_metrics),
    )
