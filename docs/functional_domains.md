...
| S-17 | 永続化ストア層 | `infrastructure/collection_store.py` `infrastructure/local_repository/json_store.py` `infrastructure/aws/dynamodb_store.py` | 全領域 | 全 repository(通知 / 推奨 / 保有 / 監視 / 評価 / 監査)+ migrations + EDINET cache |
